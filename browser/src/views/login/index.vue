<template>
  <div class="login-container">
    <el-form class="login-form" autoComplete="on" :model="loginForm" :rules="loginRules" ref="loginForm"
      ...
      <el-button type="primary" style="width:100%;margin-bottom:30px;" :loading="loading" @click.native.prevent="handleLogin">登录
      </el-button>
      <div class="tips">
        <span>超级管理员帐号 : admin</span>
        <span>密码 : 123456</span>
      </div>
      <div class="tips">
        <span style="margin-right:18px;">管理员帐号 : linran</span>
        <span>密码 : 123456</span>
      </div>
      <div class="tips">
        <span style="margin-right:18px;">学生帐号 : student</span>
        <span>密码 : 123456</span>
      </div>
